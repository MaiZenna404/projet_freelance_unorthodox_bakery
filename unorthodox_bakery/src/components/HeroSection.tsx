export default function HeroSection() {
  return (
    <>
      {/* Hero Section */}
      <div id="hero" className="flex flex-col items-center justify-center min-h-[60vh] pt-[18%] px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white/25 to-transparent mb-[3%]">
